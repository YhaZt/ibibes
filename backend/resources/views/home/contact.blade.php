    ...
    <section id="contact" class="mt-5 py-3 py-md-5 py-xl-8">
        <div class="container">
            <div class="row justify-content-md-center">
                <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                    <h2 class="mb-4 display-5 text-center">Need Help</h2>
                    <p class="text-secondary mb-5 text-center lead fs-4">Our MinSU | i-BIBES team is available to provide prompt and
                                    ...
                                    <div class="row align-items-lg-center justify-content-center h-100">
                                        <div class="col-11 col-xl-10">
                                            <div class="contact-info-wrapper py-4 py-xl-5">
                                                ...
                                                <p class="lead fs-4 text-light opacity-75 mb-4 mb-xxl-5">We're always on
                                                    the lookout to work with new clients. If you're interested in
                                                ...
                                                <div class="d-flex mb-4 mb-xxl-5">
                                                    ...
                                                    <div>
                                                        ...
                                                        <address class="mb-0 text-light opacity-75">Alcate, Victoria | Oritental Mindoro</address>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <p class="mb-0">
                                                                    <a class="link-light link-opacity-75 link-opacity-100-hover text-decoration-none"
                                                                        href="tel:+15057922430">(+63) 9123456789</a>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-xxl-6">
                                                        <div class="d-flex mb-0">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p class="mb-0">
                                                                    <a class="link-light link-opacity-75 link-opacity-100-hover text-decoration-none"
                                                                        href="mailto:ibibes@minsu.edu.ph">ibibes@minsu.edu.ph</a>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="d-flex mb-1">
                                                            ...
                                                            <p class="text-light opacity-75 mb-0">8am - 5pm</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
